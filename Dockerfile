FROM klakegg/hugo:0.94.1-ext-ubuntu AS builder
...
LABEL org.opencontainers.image.title "acend.ch's Go Basics Training"
LABEL org.opencontainers.image.description "Container with acend.ch's Go Training content"
LABEL org.opencontainers.image.authors acend.ch
LABEL org.opencontainers.image.source https://github.com/acend/go-basics-training/
